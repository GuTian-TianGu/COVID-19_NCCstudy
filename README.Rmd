...
table_1 = table1::table1(~ Age+Male+Early_Infection+History_of_Surgery+Hypertension+CHD+Chronic_Bronchitis+COPD+Diabetes+Cerebral_Infarction +Cardiac_Failure+Renal_Failure+Hepatic_Failure+Total_Chronic|Death, data=covid_table,droplevels=F, render=rndr, render.strat=rndr.strat)
...
knitr::kable(coefficients(summary(coxph(Surv(time=Followup_Days, event=Death)~Total_Chronic, data = covid_sub, weights = 1/KMP, robust=TRUE))))
